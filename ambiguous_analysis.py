"""
Analisis Teks Ambigu - Teks yang model ragu-ragu
Menganalisis teks dengan probabilitas sekitar 50% (model tidak yakin)
"""
...
# Ambil probabilitas untuk label AI
proba_ai = y_proba[:, 1]
...
# Analisis label sebenarnya dari teks ambigu
print("\n" + "-"*70)
...
if len(wrong_indices) > 0:
    ...
    for idx in wrong_indices:
        ...
        if prob > 0.7:  # Yakin >70% tapi salah
...
# Analisis teks "borderline" (45-55%)
print("\n" + "="*70)
print("ANALISIS TEKS BORDERLINE (ZONE OF UNCERTAINTY)")
print("="*70)

# Cari teks yang benar tapi dengan confidence rendah
...
for idx in correct_indices:
    prob = proba_ai[idx] if y_pred[idx] == 1 else (1 - proba_ai[idx])
    if prob < 0.6:  # Benar tapi confidence rendah (<60%)
...
if len(ambiguous_indices) > 0:
    # Statistik panjang teks ambigu vs non-ambiguous
